...
namespace RentalKendaraan.Models
{
    public partial class RentKendaraanContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdKendaran);

                entity.Property(e => e.IdKendaran)
                    .HasColumnName("ID_Kendaran")
                    .ValueGeneratedNever();
            ...
            modelBuilder.Entity<Pengembalian>(entity =>
            {
                ...
                entity.Property(e => e.IdKondisiq).HasColumnName("ID_Kondisiq");
                ...
                entity.HasOne(d => d.IdKondisiqNavigation)
                    .WithMany(p => p.Pengembalian)
                    .HasForeignKey(d => d.IdKondisiq)
